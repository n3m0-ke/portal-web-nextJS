                            ...
                            <div className="flex flex-col gap-5 items-center desktop:items-stretch w-full">
                                ...
                                <div className="space-y-3">
                                    <a href="#" className="flex group">
                                        <div
                                            className="flex gap-4 items-center group-hover:bg-neutral-200 desktop:px-4 px-3 py-3 rounded-full hover-transition">
                                    ...
                                    <a href="#" className="flex group">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="2" stroke="currentColor" aria-hidden="true" className="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14">
    
                                                </path>
                                            </svg>
                                            <span className=" text-[1.25rem] hidden desktop:block">Explore</span>
                                        </div>
                                    </a>
                                    <a href="#" className="flex group">
                                        <div
                                            ...
                                            <span className=" text-[1.25rem] hidden desktop:block">Notifications</span>
                                        </div>
                                    </a>
                                    <a href="#" className="flex group">
                                        <div
                                            ...
                                            <span className=" text-[1.25rem] hidden desktop:block">Messages</span>
                                        </div>
                                    </a>
                                    <a href="#" className="flex group">
                                        <div
                                            ...
                                            <span className=" text-[1.25rem] hidden desktop:block">Bookmarks</span>
                                        </div>
                                    </a>
                                    <a href="#" className="flex group">
                                        <div
                                            ...
                                            <span className=" text-[1.25rem] hidden desktop:block">Lists</span>
                                        </div>
                                    </a>
                                    <a href="#" className="flex group">
                                        <div
                                            ...
                                            <span className=" text-[1.25rem] hidden desktop:block">Profile</span>
                                        </div>
                                    </a>
                                    <a href="#" className="flex group">
                                        <div
                                            ...
                                            <span className=" text-[1.25rem] hidden desktop:block">More</span>
                                        </div>
                                    </a>
                                </div>
                                <button
